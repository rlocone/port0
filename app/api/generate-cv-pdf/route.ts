...
<body>
  <div class="container">
    ...
    <section>
      ...
      <div class="project">
        <div class="project-header">
          ...
          <span class="project-link">mission-control.phipi.io</span>
        </div>
        <ul>
      ...
      <div class="project">
        <div class="project-header">
          ...
          <span class="project-link">port0.me</span>
        </div>
        <ul>
    ...
    <footer>
      <p>Generated from port0.me/resume</p>
    </footer>
  </div>
</body>
</html>
...
export async function GET() {
  try {
    const pdfPath = join(process.cwd(), 'public', 'CV_Revised.pdf');
